...
const useTimerFn =  (timer:Timer,currentBtn:string,times:string[],currentInterval:number, finalObj:SittingTimer,setCurrentBtn:any,setCurrentInterval:any,  handleClickStart:(a?:number)=>void, handleClickStop:()=>void,setResultBtn:any,setRemaining:any )  => {
